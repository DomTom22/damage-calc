...
var XY_PATCH = {
    ...
    Crawdaunt: { otherFormes: ['Crawdaunt-Mega'] },
    Cryogonal: { otherFormes: ['Cryogonal-Mega'] },
    Donphan: { otherFormes: ['Donphan-Mega'] },
    Eevee: { otherFormes: ['Eevee-Mega'] },
    Exploud: { bs: { sd: 73 } },
    ...
    Jirachi: { otherFormes: ['Jirachi-Mega'] },
    Jumpluff: { bs: { sd: 95 } },
    ...
    Politoed: { otherFormes: ['Politoed-Mega'] },
    Poliwrath: { bs: { at: 95 }, otherFormes: ['Poliwrath-Mega'] },
    Raichu: { bs: { sp: 110 } },
    ...
    Staraptor: { bs: { sd: 60 } },
    Steelix: { otherFormes: ['Steelix-Mega', 'Steelix-Mega-Fire'] },
    Stoutland: { bs: { at: 110 } },
    Stunfisk: { otherFormes: ['Stunfisk-Mega'] },
    Sudowoodo: { otherFormes: ['Sudowoodo-Mega'] },
    Sunflora: { otherFormes: ['Sunflora-Mega-F', 'Sunflora-Mega-M'] },
    ...
    Zebstrika: { otherFormes: ['Zebstrika-Mega'] },
  ...
  Sphericoil: {
    types: ['Electric'],
    bs: {hp: 80, at: 50, df: 70, sa: 105, sd: 95, sp: 165},
    weightkg: 123.2,
    abilities: {0: 'Sound Proof'},
  },
  ...
  'Porygon-X': {
    types: ['Electric', 'Normal'],
    bs: {hp: 75, at: 65, df: 70, sa: 115, sd: 75, sp: 140},
    weightkg: 34,
    abilities: {0: 'Adaptability'},
  },
  //Chromatic
  'Accelgor-Chromatic': {
    types: ['Bug', 'Dark'],
    bs: {hp: 80, at: 130, df: 40, sa: 80, sd: 60, sp: 145},
    weightkg: 25.3,
    abilities: {0: 'Sticky Hold'},
  },
  'Aurorus-Chromatic': {
  ...
  'Dragalge-Chromatic': {
    types: ['Grass', 'Water'],
    bs: {hp: 81, at: 85, df: 84, sa: 106, sd: 125, sp: 44},
    weightkg: 81.5,
    abilities: {0: 'Regenerator'},
  },
  'Glalie-Chromatic': {
    types: ['Fire', 'Ground'],
    bs: {hp: 100, at: 90, df: 80, sa: 90, sd: 80, sp: 80},
    weightkg: 256.5,
    abilities: {0: 'Drought'},
  },
  'Glalie-Chromatic-Mega': {
    types: ['Fire', 'Ground'],
    bs: {hp: 100, at: 125, df: 90, sa: 120, sd: 80, sp: 105},
    weightkg: 350.2,
    abilities: {0: 'Rock Head'},
  ...
  'Hypno-Chromatic': {
    types: ['Ghost', 'Dark'],
    bs: {hp: 85, at: 68, df: 115, sa: 90, sd: 75, sp: 67},
    weightkg: 75.6,
    abilities: {0: 'Noctem'},
  },
  'Leavanny-Chromatic': {
    types: ['Bug', 'Steel'],
    bs: {hp: 75, at: 110, df: 80, sa: 60, sd: 80, sp: 102},
    weightkg: 20.5,
  ...
  'Vespiquen-Chromatic': {
    types: ['Poison', 'Steel'],
    bs: {hp: 81, at: 89, df: 118, sa: 80, sd: 92, sp: 40},
    weightkg: 38.5,
    abilities: {0: 'Levitate'},
  },
  'Zebstrika-Chromatic': {
    types: ['Ground', 'Electric'],
    bs: {hp: 87, at: 128, df: 83, sa: 40, sd: 83, sp: 116},
    weightkg: 79.5,
    abilities: {0: 'Guts'},
  },
  //Opalo
  ...
  Egorgeon: {
    types: ['Dragon', 'Electric'],
    bs: {hp: 80, at: 100, df: 80, sa: 140, sd: 80, sp: 120},
    weightkg: 305,
    abilities: {0: 'Multiscale'},
  },
  'Sabolt-X': {
    types: ['Electric', 'Dark'],
    bs: {hp: 118, at: 67, df: 123, sa: 142, sd: 90, sp: 60},
    weightkg: 77,
    abilities: {0: 'Intimidate'},
  },
  'Tyranitar-X': {
    types: ['Electric', 'Dark'],
    bs: {hp: 100, at: 144, df: 120, sa: 105, sd: 110, sp: 71},
    weightkg: 202,
    abilities: {0: 'Solid Rock'},
  },
  //Daybreak
  'Heliolisk-Mega': {
    types: ['Electric', 'Fire'],
    bs: {hp: 62, at: 55, df: 52, sa: 149, sd: 124, sp: 139},
    weightkg: 305,
    abilities: {0: 'Chlorophyll'},
  ...
  Sandridger: {
    types: ['Ground', 'Steel'],
    bs: {hp: 75, at: 130, df: 130, sa: 45, sd: 85, sp: 85},
    weightkg: 29.5,
    abilities: {0: 'Intimidate'},
  },
  //Sage
...
var SS_PATCH = {
    Whismur: { abilities: { 0: 'Amplifier' } },
    Loudred: { abilities: { 0: 'Amplifier' } },
    Exploud: { abilities: { 0: 'Amplifier' } },
    Primarina: { abilities: { 0: 'Amplifier' } },
    'Pawniard-Delta': { abilities: { 0: 'Technician' } },
    'Bisharp-Delta': { abilities: { 0: 'Technician' } },
    'Ralts-Delta': { abilities: { 0: 'Snow Warning' } },
    'Kirlia-Delta': { abilities: { 0: 'Snow Warning' } },
    'Gardevoir-Delta': { abilities: { 0: 'Snow Warning' } },
    'Gallade-Delta': { abilities: { 0: 'Slush Rush' } },
    'Scyther-Delta': { abilities: { 0: 'Slush Rush' } },
    'Scizor-Delta': { abilities: { 0: 'Slush Rush' } },
    'Scraggy-Delta': { abilities: { 0: 'Grassy Surge' } },
    'Scrafty-Delta': { abilities: { 0: 'Grassy Surge' } },
    'Koffing-Delta': { abilities: { 0: 'Electric Surge' } },
    'Weezing-Delta': { abilities: { 0: 'Electric Surge' } },
    'Noibat-Delta': { abilities: { 0: 'Natural Cure' } },
    'Noivern-Delta': { abilities: { 0: 'Natural Cure' } },
    'Torchic-Delta': { abilities: { 0: 'Magic Guard' } },
    'Combusken-Delta': { abilities: { 0: 'Magic Guard' } },
